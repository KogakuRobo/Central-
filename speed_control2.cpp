...
speed_control::speed_control(my_position*pmy_posi, target_point*pt_point) :pid_x(300, 0, 0, 0.01), pid_y(300, 0, 0, 0.01), pid_yaw(800, 0, 50, 0.01) {
	for (int i = 0; i <= 2; i++) {
		t_posi[i];
		speed_F[i];
		speed_B[i];
